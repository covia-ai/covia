...
Covia currently targets the locally installed Convex 0.8.14-SNAPSHOT development build. Install that snapshot from the Convex checkout before building Covia.
