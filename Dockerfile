...
# sun.misc.unsafe.memory.access: JDK 24+ warns once when protobuf-java touches
# Unsafe (JEP 471); that warning is for the library, not the operator. The -D
# form is what the launcher's --sun-misc-unsafe-memory-access maps onto.
