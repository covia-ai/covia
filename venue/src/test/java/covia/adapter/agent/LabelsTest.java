...
public class LabelsTest {
	...
	public void testXmlClosesWhatItOpens() {
		...
		// Trusted instruction-label attributes are escaped; bodies are verbatim.
		assertEquals("<loaded-skill name=\"a &quot;b&quot; &lt;c>\" unload-key=\"w/x\">1 < 2</loaded-skill>",
			Labels.render(Labels.XML, Kind.LOADED_SKILL, "1 < 2", "a \"b\" <c>", "w/x"));
	}
