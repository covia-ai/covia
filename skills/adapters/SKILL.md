...
| Modules (not in covia.jar) | `sql` (covia-sql), `python` (covia-python-adapter), `telegram` (covia-telegram), `discord` (covia-discord), `sonnylabs` (covia-sonnylabs), `claudecode` (covia-claude-code) |
| Testing | `test` |
